...
//    private val tripId: String by lazy { arguments?.getString(TRIP_ID) ?: "" }
//    private val phone: String by lazy { arguments?.getString(PHONE_TEXT) ?: "" }
//    private val transactionId: String by lazy { arguments?.getString(TRANSACTION_ID) ?: "" }
//
//    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
//        super.onViewCreated(view, savedInstanceState)
//
...
//        setupObservers()
//
//        // Загрузка данных в зависимости от режима (редактирование/создание)
//        if (transactionId.isNotEmpty()) {
//            viewModel.loadTransactionForEditing(tripId, transactionId)
//        } else {
//            viewModel.loadParticipants(tripId, phone)
...
//            // Обработка кликов
//            ivBackIcon.setOnClickListener { viewModel.navigateToTransactions(tripId, phone) }
//            btnOnePerson.setOnClickListener { viewModel.updateSplitType(SplitType.ONE_PERSON) }
//            btnSplitEqually.setOnClickListener { viewModel.updateSplitType(SplitType.EQUALLY) }
//            btnAddParticipant.setOnClickListener { viewModel.updateSplitType(SplitType.MANUALLY) }
//            btnCreate.setOnClickListener { createTransaction() }
//
//            // Отслеживание изменения суммы
//            etTotalAmount.addSimpleTextWatcher { amount ->
//                viewModel.updateTotalAmount(amount.orEmpty())
//            }
//        }
//    }
//
...
//    private suspend fun observeFormState() {
//        viewModel.formState.collect { formState ->
//            updateSplitTypeUI(formState.splitType)
//
//            viewBinding.apply {
//                // Обновление суммы, если она изменилась
//                if (etTotalAmount.text?.toString() != formState.totalAmount) {
//                    etTotalAmount.setText(formState.totalAmount)
//                }
//
//                // Обновление описания
//                descriptionInputLayout.editText?.setText(formState.description)
//
...
//            if (event is TransactionEvent.ValidationError) {
//                event.errors.firstOrNull()?.let { error ->
//                    showToast(error.messageRes)
//                }
//            }
//        }
...
//    }
//
//    private fun updateSplitTypeUI(splitType: SplitType) {
//        val selectedColor = ContextCompat.getColor(requireContext(), R.color.yellow)
//        val defaultColor = ContextCompat.getColor(requireContext(), R.color.image_back)
//        val selectedIconColor = ContextCompat.getColor(requireContext(), R.color.black)
//        val defaultIconColor = ContextCompat.getColor(requireContext(), R.color.image_photo)
...
//            btnOnePerson.backgroundTintList = colorStateList(splitType == SplitType.ONE_PERSON, selectedColor, defaultColor)
//            btnSplitEqually.backgroundTintList = colorStateList(splitType == SplitType.EQUALLY, selectedColor, defaultColor)
//            btnAddParticipant.backgroundTintList = colorStateList(splitType == SplitType.MANUALLY, selectedColor, defaultColor)
//
//            // Обновление цвета иконок
//            btnOnePerson.iconTint = colorStateList(splitType == SplitType.ONE_PERSON, selectedIconColor, defaultIconColor)
//            btnSplitEqually.iconTint = colorStateList(splitType == SplitType.EQUALLY, selectedIconColor, defaultIconColor)
//            btnAddParticipant.iconTint = colorStateList(splitType == SplitType.MANUALLY, selectedIconColor, defaultIconColor)
//        }
//    }
//
//    private fun colorStateList(condition: Boolean, trueColor: Int, falseColor: Int) =
